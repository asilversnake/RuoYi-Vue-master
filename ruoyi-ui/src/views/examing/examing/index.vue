    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['examing:project:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['examing:project:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['examing:project:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['examing:project:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listProject, getProject, delProject, addProject, updateProject } from "@/api/examing/project"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getProject(examId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除考试安排编号为"' + examIds + '"的数据项？').then(function() {
        return delProject(examIds)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('examing/project/export', {
        ...this.queryParams
